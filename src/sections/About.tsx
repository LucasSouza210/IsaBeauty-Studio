    ...
    return (
        <div className="w-full h-auto lg:h-[87vh] flex justify-center items-center z-10 py-16 lg:py-0 px-10 lg:px-0 relative bg-white">
            <div className="w-full lg:w-174 xl:w-218 2xl:w-280 h-auto flex flex-col items-center gap-20 lg:absolute lg:-bottom-16 xl:-bottom-20 2xl:-bottom-28 z-10">
                ...
                <div className="w-full lg:w-full flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-0">
                    ...
                    <div className="lg:flex-1 lg:h-68 xl:h-78 2xl:h-100 flex justify-center lg:rounded-tr-2xl lg:rounded-br-2xl lg:pt-8 xl:pt-9 2xl:pt-12 lg:bg-[#C89A76]">
                        <div className="flex flex-col items-center lg:items-start gap-4 lg:gap-3.5 xl:gap-3.5 2xl:gap-7">
                            ...
                            <p className="mb-4 lg:mb-0 lg:whitespace-nowrap dmFont text-xs font-normal 2xl:font-medium lg:text-[9px] xl:text-[11px] 2xl:text-sm leading-4.5 lg:leading-3.5 xl:leading-4 2xl:leading-5 lg:tracking-[0.085em] xl:tracking-[0.09em] xl:mb-2 2xl:mb-0 lg:text-white">Over the years, I have completed multiple courses and earned certifications in <br className="hidden lg:block"/> different countries, gaining an international perspective on the latest beauty <br className="hidden lg:block"/> techniques and trends. At IsaBeauty, quality is essential. I work with carefully <br className="hidden lg:block"/> selected products and treatments that deliver real results, always tailored to <br className="hidden lg:block"/> your skin and individual needs.</p>
