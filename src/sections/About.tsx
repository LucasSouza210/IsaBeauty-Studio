...
export default function About() {
    return (
        <div className="w-full xl:h-[87vh] flex justify-center z-10 relative bg-white">
            <div className="xl:w-224 2xl:w-280 h-auto flex flex-col absolute xl:-bottom-20 2xl:-bottom-28 z-10">
                ...
                <div className="w-full flex">
                    ...
                    <div className="flex-1 flex items-center justify-center rounded-tr-2xl rounded-br-2xl relative bg-[#C89A76]">
                        <div className="2xl:w-114 flex flex-col items-start xl:gap-5 2xl:gap-7 absolute xl:top-9 2xl:top-9.5">
                            <p className="xl:w-115 2xl:w-126 dmFont font-semibold xl:text-[21px] 2xl:text-2xl xl:leading-5 2xl:leading-6 tracking-wide text-[#6B452E]">With over 10 years of experience in the beauty industry, I combine professional expertise with a true passion for skin improvement and self-care.</p>
                            <p className="xl:w-110 2xl:w-120 dmFont xl:font-medium xl:text-xs 2xl:text-sm leading-4 tracking-widest 2xl:tracking-wider xl:mb-2 2xl:mb-0 text-white">Over the years, I have completed multiple courses and earned certifications in different countries, gaining an international perspective on the latest beauty techniques and trends. At IsaBeauty, quality is essential. I work with carefully selected products and treatments that deliver real results, always tailored to your skin and individual needs.</p>
