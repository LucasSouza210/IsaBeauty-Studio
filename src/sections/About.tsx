                ...
                <div className="w-full flex">
                    ...
                    <div className="flex-1 flex justify-center rounded-tr-2xl rounded-br-2xl lg:pt-8 xl:pt-9 2xl:pt-12 bg-[#C89A76]">
                        <div className="flex flex-col items-start lg:gap-3.5 xl:gap-3.5 2xl:gap-7">
                            <p className="whitespace-nowrap dmFont font-semibold lg:text-base xl:text-[19px] 2xl:text-2xl lg:leading-4 xl:leading-5 2xl:leading-6.5 lg:tracking-[0.010em] xl:tracking-wide text-[#6B452E]">With over 10 years of experience in the beauty <br /> industry, I combine professional expertise with <br /> a true passion for skin improvement and self-care.</p>
                            <p className="whitespace-nowrap dmFont xl:font-medium lg:text-[9px] xl:text-[11px] 2xl:text-sm lg:leading-3.5 xl:leading-4 2xl:leading-5 lg:tracking-[0.075em] xl:tracking-[0.07em] 2xl:tracking-wider xl:mb-2 2xl:mb-0 text-white">Over the years, I have completed multiple courses and earned certifications in <br /> different countries, gaining an international perspective on the latest beauty <br /> techniques and trends. At IsaBeauty, quality is essential. I work with carefully <br /> selected products and treatments that deliver real results, always tailored to <br /> your skin and individual needs.</p>
