...
export default function About() {
    return (
        <div className="w-full lg:h-[87vh] flex justify-center z-10 relative bg-white">
            <div className="lg:w-180 xl:w-218 2xl:w-280 h-auto flex flex-col absolute lg:-bottom-16 xl:-bottom-20 2xl:-bottom-28 z-10">
                ...
                <div className="w-full flex">
                    <div className="lg:h-69 xl:h-80 2xl:h-106 lg:w-70 xl:w-86 2xl:w-120 flex justify-center relative overflow-visible rounded-tl-2xl rounded-bl-2xl bg-zinc-400">
                    ...
                    <div className="flex-1 flex items-center justify-center rounded-tr-2xl rounded-br-2xl relative bg-[#C89A76]">
                        <div className="flex flex-col items-start lg:gap-4 xl:gap-5 2xl:gap-7 absolute xl:top-9 2xl:top-9.5">
                            <p className="whitespace-nowrap dmFont font-semibold lg:text-base xl:text-[19px] 2xl:text-2xl xl:leading-5 2xl:leading-6 lg:tracking-[0.010em] xl:tracking-wide text-[#6B452E]">With over 10 years of experience in the beauty <br /> industry, I combine professional expertise with <br /> a true passion for skin improvement and self-care.</p>
                            <p className="whitespace-nowrap dmFont xl:font-medium lg:text-[9px] xl:text-[11px] 2xl:text-sm leading-4 lg:tracking-[0.07em] xl:tracking-[0.07em] 2xl:tracking-wider xl:mb-2 2xl:mb-0 text-white">Over the years, I have completed multiple courses and earned certifications in <br /> different countries, gaining an international perspective on the latest beauty <br /> techniques and trends. At IsaBeauty, quality is essential. I work with carefully <br /> selected products and treatments that deliver real results, always tailored to <br /> your skin and individual needs.</p>
