                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col">
                            <p className="2xl:w-106 dmFont font-semibold text-[26px] leading-[30px] text-black">YOU DON’T HAVE TO LIVE WITH SKIN OR BODY INSECURITIES.</p>
                            <p className="dmFont font-semibold text-[46px] text-[#6A4830]">I can help you change that.</p>
                        </div>
                        <p className="2xl:w-118 fontPoppins font-semibold text-sm leading-[22px] text-black">If you struggle with acne, pigmentation, dull skin, sagging, localized fat or lack of firmness. I create targeted facial and body treatments designed to correct, improve and restore your confidence. Your concerns are specific. Your treatment should be too.</p>
                    </div>
