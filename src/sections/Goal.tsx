...
export default function Goal() {
    return (
        <div className="w-full lg:h-110 xl:h-132 2xl:h-160 flex justify-center px-10 lg:px-0 py-14 lg:py-0 bg-white">
            <div className="w-full lg:w-176 xl:w-218 2xl:w-280 h-full flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-12 xl:gap-15 2xl:gap-18 overflow-x-visible">
