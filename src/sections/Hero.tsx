...
export default function Hero() {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center bg-cover bg-center" style={{ backgroundImage: `url(${background})` }}>
            <div className="2xl:w-280 min-h-full flex flex-col justify-center items-start 2xl:gap-9 relative">
                <div className="flex flex-col gap-9 items-start absolute top-42">
                    <img src={logo} alt="" className="2xl:h-18 w-auto mb-2" />
                    <p className="2xl:max-w-152 dmFont font-semibold 2xl:text-[54px] leading-15 tracking-normal text-[#6A4830]">Awaken the best version of you, take care of your skin, take care of yourself.</p>
                ...
                <img src={isa} alt="" className="2xl:h-306 absolute right-0 -bottom-88" />
                <div className="w-full flex flex-col gap-8 absolute -bottom-40 z-20">
                    <p className="poppinsFont font-bold text-lg leading-[1.44]">Some brands we reached</p>
                    <div className="grid grid-cols-3 gap-8">
                        {
                            data.map((i, index) => (
                                <div className="w-full h-58 flex items-end justify-center rounded-[10px] bg-white shadow-[0px_7px_24px_0px_rgba(0,0,0,0.25)]" key={index}>
