...
export default function Hero() {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center bg-cover bg-center" style={{ backgroundImage: `url(${background})` }}>
            <div className="xl:w-224 2xl:w-280 min-h-full flex flex-col justify-center items-start 2xl:gap-9 relative">
                ...
                <img src={isa} alt="" className="xl:h-242 2xl:h-306 absolute right-0 xl:-bottom-72 2xl:-bottom-88" />
