        ...
        <div className="w-full min-h-screen flex justify-center bg-cover bg-center lg:p-0 pt-12 sm:pt-13 md:pt-14 lg:pt-0 px-10 sm:px-16 lg:px-0 pb-10 sm:pb-12 lg:pb-0" style={{ backgroundImage: `url(${background})` }}>
            <div className="w-full sm:w-7/10 lg:w-176 xl:w-218 2xl:w-280 min-h-full flex flex-col lg:justify-center lg:items-start gap-9 sm:gap-10 md:gap-12 lg:gap-0 2xl:gap-9 relative">
                <div className="w-full lg:w-auto flex flex-col items-center lg:items-start gap-6 sm:gap-6.5 md:gap-8 lg:gap-5.5 xl:gap-7 2xl:gap-9 lg:absolute lg:top-38 xl:top-36 2xl:top-42">
                    ...
                    <p className="whitespace-nowrap dmFont font-semibold text-center lg:text-start text-xl sm:text-3xl md:text-[36px] lg:text-[34px] xl:text-[43px] 2xl:text-[52px] leading-7 sm:leading-9 md:leading-11 lg:leading-9 xl:leading-11 2xl:leading-15 sm:tracking-wide md:tracking-wider lg:tracking-normal xl:tracking-normal text-[#6A4830]">Awaken the best version <br className="hidden lg:block"/> of<br className="lg:hidden"/> you, take care of your <br className="hidden lg:block"/> skin,<br className="lg:hidden"/> take care of yourself.</p>
                    <p className="whitespace-nowrap poppinsFont font-semibold text-center lg:text-start text-xs sm:text-sm md:text-[17px] lg:text-[10px] xl:text-sm 2xl:text-base tracking-wide sm:tracking-wider md:tracking-[0.085em] lg:tracking-[0.030em] xl:tracking-normal leading-4.5 sm:leading-5.5 md:leading-6.5 lg:leading-4 xl:leading-6 2xl:leading-6.5">With my experience, I’m confident I can help you<br className="lg:hidden"/> achieve the skin <br className="hidden lg:block"/> of your dreams. I can’t wait<br className="lg:hidden"/> to welcome you to my treatment room!</p>
