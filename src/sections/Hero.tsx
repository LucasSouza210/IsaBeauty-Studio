        ...
        <div className="w-full min-h-screen flex justify-center bg-cover bg-center" style={{ backgroundImage: `url(${background})` }}>
            <div className="2xl:w-300 min-h-full flex flex-col justify-center items-start 2xl:gap-9 relative">
                <div className="flex flex-col gap-9 items-start">
                    <img src={logo} alt="" className="2xl:h-36 w-auto" />
                    <p className="2xl:max-w-182 dmFont font-semibold 2xl:text-[64px] leading-15 tracking-normal text-[#6A4830]">Awaken the best version of you, take care of your skin, take care of yourself.</p>
                ...
                <div className="w-full flex flex-col gap-8 absolute -bottom-46 z-10">
                    <p className="poppinsFont font-bold text-lg leading-[1.44]">Some brands we reached</p>
                    <div className="grid grid-cols-3 gap-8">
                        {
                            data.map(i => (
                                <div className="w-full h-62 flex items-end justify-center rounded-[10px] z-10 bg-white shadow-[0px_7px_24px_0px_rgba(0,0,0,0.25)]">
