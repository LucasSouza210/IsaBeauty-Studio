...
export default function Hero() {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center bg-cover bg-center" style={{ backgroundImage: `url(${background})` }}>
            <div className="lg:w-180 xl:w-218 2xl:w-280 min-h-full flex flex-col justify-center items-start 2xl:gap-9 relative">
                ...
                <div className="w-full flex flex-col lg:gap-5 xl:gap-6 2xl:gap-7 absolute lg:-bottom-28 xl:-bottom-32 2xl:-bottom-40 z-20">
                    ...
                    <div className="grid grid-cols-3 lg:gap-6 xl:gap-7 2xl:gap-8">
                        {
                            data.map((i, index) => (
                                <div className="w-full lg:h-38 xl:h-46 2xl:h-58 flex items-end justify-center rounded-[10px] bg-white shadow-[0px_7px_24px_0px_rgba(0,0,0,0.25)]" key={index}>
